            ...
            <section className="filter-container">
                ...
                {/*select type */}
                 ...
                 <div className="form-group ">
                  ...
                  {/*room price */}
                  <div className="form-group">
                   <label htmlFor="price">Room Price is ${price}</label>
                   <input type="range" name="price" min={minPrice} max={maxPrice} id="price" onChange={handleChange} className="form-control"/>
                  </div>
                  {/* end of room price*/}
                  {/*size */}
                  <div className="form-group">
